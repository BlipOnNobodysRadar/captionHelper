...
def build_native_av_content(video_path: str, text: str, audio_path: str | None = None) -> list[dict]:
    """Build recent llama.cpp OpenAI-compatible input_video/input_audio content."""
    content = [{"type": "input_video", "input_video": {"data": _raw_base64(video_path)}}]
    if audio_path:
